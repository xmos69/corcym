...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    document.getElementById('carousel').addEventListener('click', agrandissement);
    document.getElementById('agrandissement').addEventListener('click', retrecissement);
});
...
function agrandissement() {
    ...
    let carousel = document.getElementsByClassName('chemin');

    let src = carousel.children;
    console.log(carousel);
    console.log(src);
    console.log(toto);
    document.getElementById("agrandissement").src = "src";
}

function retrecissement() {
    document.getElementById("agrandissement").src = "";
    document.getElementById("carousel-container").style.display = "block";
    location.reload();

}

setInterval("next(1)", 4000);